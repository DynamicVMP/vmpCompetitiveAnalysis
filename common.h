...
float*load_weighted_sums(float **objective_functions_values_aux, float *weighted_sums, int **population, int ***utilization, int **H, float **V, int number_of_individuals, int h_size, int v_size, int *OF_calc_count);
